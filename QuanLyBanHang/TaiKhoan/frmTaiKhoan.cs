...
namespace QuanLyBanHang
{
    ...
    public partial class frmTaiKhoan : Form
    {
        ...
        private void btn_them_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    string them1 = "insert into taikhoan Values (N'" + uername + "', N'" + password + "', N'" + fullname + "', '" + date + "', '" + role + "')";
        ...
        private void btn_sua_Click(object sender, EventArgs e)
        {
            ...
            string sql = "Update taikhoan set password = N'" + password + "', fullname = N'" + fullname + "', isAdmin = '" + role +
                         "' where username = N'" + txt_tk.Text + "'";
