...
namespace QuanLyBanHang.quanly
{
    public partial class frmThongTinDonHang : Form
    {
        ...
        public void Load_dta1()   
        {
            ...
            db1.Columns[0].HeaderText = "Mã đơn";
            db1.Columns[1].HeaderText = "Tên và số lượng";
            db1.Columns[2].HeaderText = "Ngày bán";
            db1.Columns[3].HeaderText = "Tổng giá trị";
            db1.Columns[4].HeaderText = "Người nhập";
        }
