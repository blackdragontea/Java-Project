...
{ 
    public partial class sanpham : Form
    {
        ...
        public void clear()
        {
            ...
            dta1.Columns[0].HeaderText = "Mã Sản phẩm";
            dta1.Columns[1].HeaderText = "Tên sản phẩm";
            dta1.Columns[2].HeaderText = "Nhà cung cấp";
            dta1.Columns[3].HeaderText = "Giá  nhập";
            dta1.Columns[4].HeaderText = "Giá bán";
            dta1.Columns[5].HeaderText = "Số lượng";
            dta1.Columns[6].HeaderText = "Hạn sử dụng";
            dta1.Columns[7].HeaderText = "Nơi sản xuất";
            dta1.Columns[8].HeaderText = "Đơn vị tính";
            dta1.Columns[9].HeaderText = "Người nhập";
            mancc();
            txt_masp.Focus();
            txt_masp.Text = "";
            txt_tensp.Text = "";
        ...
        private void btn_them_Click(object sender, EventArgs e)
        {
            ...
            {
                DateTime hsd = DateTime.Parse(txt_hsd.Text);
                string hsdFormatted = hsd.ToString("yyyy-MM-dd");

                string sql1 = "Insert into sanpham (tensp, mancc, gianhap, giaban, solg, hsd, noisx, donvitinh, nguoinhap) " +
                              "values (N'" + txt_tensp.Text + "', N'" + txt_mancc.SelectedValue + "', '" + txt_gianhap.Text + "', '" + txt_giaban.Text + "', '" + txt_solg.Text + "', '" + hsdFormatted + "', N'" + txt_nsx.Text + "', N'" + txt_dvt.Text + "', N'" + txtNguoiNhap.Text + "')";
        ...
        private void bnt_sua_Click(object sender, EventArgs e)
        {
            ...
            string sql = "Update sanpham set tensp = N'" + txt_tensp.Text + "', mancc = N'" + txt_mancc.SelectedValue + "', gianhap = '" + txt_gianhap.Text + "', giaban = '" + txt_giaban.Text + "', solg = '" + txt_solg.Text + "', hsd = '" + hsdFormatted + "', noisx = N'" + txt_nsx.Text + "', donvitinh = N'" + txt_dvt.Text + "', nguoinhap = N'" + txtNguoiNhap.Text + "' where masp = '" + txt_masp.Text + "'";
